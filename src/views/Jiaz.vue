...
<van-pull-refresh
 v-model="state.loading" style="min-height: 1vh;" :head-height="105" @refresh="onRefresh">
...
<div style="margin-top:90px">
    <div 
     ...
     :key="index"
     @click="goToCaseParticular(item.particularId)"
    >
...
import Head3 from "../components/Index/Head3.vue";
...
this.getcasesList();
  ...
  methods:{
    ...
    goToCaseParticular(id) {
      this.$router.push({ name: "CaseParticular", params: { particularId: id } });
    },
  },
